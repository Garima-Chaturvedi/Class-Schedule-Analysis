...
public void map(Object key, Text value, Context context
	...
	String key1=key0[0]+" "+key0[1]+" "+key0[2];
	word.set(key1);
	context.write(word,new IntWritable(1));
}
}
...
public void reduce(Text key, Iterable<IntWritable> values,
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "getting total number of days a class is accessed in a week");
    job.setJarByClass(TimeSlots.class);
    ...
    Job job2 = Job.getInstance(conf2, "getting total number of days a class is used for a timeslot in a week");
    job2.setJarByClass(TimeSlots.class);
    job2.setMapperClass(Mapper2.class);
    //job2.setCombinerClass(FindIncreaseReducer.class);
    job2.setReducerClass(Reducer2.class);
    job2.setOutputKeyClass(Text.class);
    job2.setOutputValueClass(IntWritable.class);
    FileInputFormat.addInputPath(job2, new Path("Tempts9"));
